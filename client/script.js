...
const repeatMyParam = () => {
    ...
    return axios.get('http://localhost:3000/repeat/cats')
.then(res => res.data)
 
}

sayHelloButton.addEventListener("click", repeatMyParam);
...
document.getElementById('query-button').addEventListener('click', ohMy);
